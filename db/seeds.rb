...
default_char2 = Character.create!(
  ...
  default_char2.image.attach(io: file, filename: "captain_stella.png", content_type: "image/png"),
  profile_id: nil,
  is_custom: false
)
...
default_char3 = Character.create!(
  ...
  default_char3.image.attach(io: file, filename: "blaze_dragon.png", content_type: "image/png"),
  profile_id: nil,
  is_custom: false
)
